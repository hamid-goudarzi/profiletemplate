                    ...
                    <div className="row">
                        <div className="col-md-4 col-xs-6">
                            <div className="portfolio-item">
                                <img src="img/portfolio-1.jpg" className="img-res" alt="" />
                        ...
                        <div className="col-md-4 col-xs-6">
                            <div className="portfolio-item">
                                <img src="img/portfolio-2.jpg" className="img-res" alt="" />
                                <div className="portfolio-item-info">
                                    <h4>Project Title</h4>
                        ...
                        <div className="col-md-4 col-xs-6">
                            <div className="portfolio-item">
                                <img src="img/portfolio-3.jpg" className="img-res" alt="" />
                                <div className="portfolio-item-info">
                                    <h4>Project Title</h4>
                        ...
                        <div className="col-md-4 col-xs-6">
                            <div className="portfolio-item">
                                <img src="img/portfolio-4.jpg" className="img-res" alt="" />
                                <div className="portfolio-item-info">
                                    <h4>Project Title</h4>
                        ...
                        <div className="col-md-4 col-xs-6">
                            <div className="portfolio-item">
                                <img src="img/portfolio-5.jpg" className="img-res" alt="" />
                                <div className="portfolio-item-info">
                                    <h4>Project Title</h4>
                        ...
                        <div className="col-md-4 col-xs-6">
                            <div className="portfolio-item">
                                <img src="img/portfolio-6.jpg" className="img-res" alt="" />
                                <div className="portfolio-item-info">
                                    <h4>Project Title</h4>
